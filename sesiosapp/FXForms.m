...
NSString *const FXFormFieldTypeRating = @"rateview";
...
static Class FXFormFieldInferClass(NSDictionary *dictionary)
{
    ...
    return @{FXFormFieldTypeLabel: [NSString class],
             ...
             FXFormFieldTypeRating: [NSString class],
             }[type];
}
...
- (instancetype)init
{
    if ((self = [super init]))
    {
        ...
        _cellClassesForFieldTypes = [@{FXFormFieldTypeDefault: [FXFormDefaultCell class],
                                      ...
                                      FXFormFieldTypeRating: [FXFormratingviewCell class],
...
- (CGFloat)tableView:(__unused UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        cellIndexPath += [self tableView:tableView numberOfRowsInSection:i];
    }
    
    cellIndexPath += indexPath.row;
    if ([hideArray containsObject:@(cellIndexPath)]){
        //NSLog(@"%d",cellIndexPath);
        return 0;
    }
...
- (void)viewDidLoad
{
    ...
    if (!self.tableView)
    {
        ...
        //set table header hidden from the view
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]))
    {
        ...
        self.textLabel.font = [UIFont fontWithName:[FXFormVariables FXFontName]   size:[FXFormVariables FXFontSize]];
        FXFormLabelSetMinFontSize(self.textLabel, FXFormFieldMinFontSize);
        //self.detailTextLabel.font = [UIFont systemFontOfSize:17];
        self.detailTextLabel.font = [UIFont fontWithName:[FXFormVariables FXFontName]   size:[FXFormVariables FXFontSize]];
...
- (void)setUp
{
    ...
    self.textField.font = [UIFont fontWithName:[FXFormVariables FXFontName]   size:[FXFormVariables FXFontSize]];
...
+ (CGFloat)heightForField:(FXFormField *)field width:(CGFloat)width
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        textView.font = [UIFont fontWithName:[FXFormVariables FXFontName]   size:[FXFormVariables FXFontSize]];
    });
...
- (void)setUp
{
    ...
    self.textView.font = [UIFont fontWithName:[FXFormVariables FXFontName]   size:[FXFormVariables FXFontSize]];
...
- (UIImage *)imageValue
{
    if (self.field.value)
    {
        if ([[FXFormVariables mediaType]  isEqual: @"video"] ){
            @autoreleasepool {
...
@interface FXFormratingviewCell () <FloatRatingViewDelegate>
@property (nonatomic, strong) FloatRatingView *ratingview;
@end
@implementation FXFormratingviewCell

- (void)setUp
{
    CGRect screenRect = [[UIScreen mainScreen] bounds];
    CGFloat screenWidth = screenRect.size.width;
    self.ratingview = [[FloatRatingView alloc] initWithFrame:CGRectMake(screenWidth - 165, 10, 150, 21)];
    self.ratingview.emptyImage = [UIImage imageNamed:@"emplystar.png"];
    self.ratingview.fullImage = [UIImage imageNamed:@"filledstar.png"];
    ...
    NSLog(@"%ld",(long)self.ratingview.tag);
...
- (void)update
{
    ...
    {
        self.ratingview.rating = [self.field.value floatValue];
    }
    NSUInteger index = self.field.value? [self.field.options indexOfObject:self.field.value]: NSNotFound;
    if (self.field.placeholder)
    {
